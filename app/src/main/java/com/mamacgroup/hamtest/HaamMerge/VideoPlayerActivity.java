...
//            String second = params.get(1);
        ...
        read_tv.setText(Settings.getword(this,"Read"));
        watch_tv=(MyTextView)findViewById(R.id.watch_tvvvvv);
        watch_tv.setText(Settings.getword(this,"Watch"));
...
//            sources.get(i).release();
        ...
        Log.e("cat_object1", AppController.getInstance().cat_images.toString());
    }
    @Override
    public void onPause() {
        super.onPause();
...
//                    prepare_players();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(VideoPlayerActivity.this, Settings.getword(VideoPlayerActivity.this,"server_not_connected"), Toast.LENGTH_SHORT).show();
                pd.setVisibility(View.GONE);
                pd_tv.setVisibility(View.GONE);
            }
